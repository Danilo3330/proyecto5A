...
public class ServletInsertPermiso extends HttpServlet {
            ...
            case "GUARDAR":
                ...
                if (motivo.equals("Otros")) {
                    ...
                    Permiso objInsertOtros = new Permiso(otrosMotivo, fechaInicioPermiso,
                            fechaFinalPermiso, HoraInicio, HoraFinal, observaciones, 
    ...
    if (motivo.equals("Otros")) {
        ...
        // Crea un nuevo objeto Permiso con el motivo detallado
        Permiso objEditOtros = new Permiso(idPermiso, otrosMotivo, fechaInicioPermiso,
                fechaFinalPermiso, HoraInicio, HoraFinal, observaciones, valordescontar, 
                usuario_idCedula);
